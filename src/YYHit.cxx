...
Double_t YYHit::ELoss(nucleus ncl, Double_t E, Double_t Theta, Double_t P)
{
	...
	E -= elMan->eloss(ncl,13./27.,E,0.1*2.702*0.1/cos(T),ncl.EL.eAl, ncl.EL.dedxAl);
  	E -= elMan->eloss(ncl,5./10.,E,0.05*2.3502*0.1/cos(T),ncl.EL.eB, ncl.EL.dedxB);
  	dE0 = elMan->eloss(ncl,14./28.,E,Thickness[sector]/cos(T),ncl.EL.eSi, ncl.EL.dedxSi);
  	dE_ideal0 = elMan->eloss(ncl,14./28.,E,Avg_Thickness/cos(T),ncl.EL.eSi, ncl.EL.dedxSi);
	E = E-dE0;
	if(dE0<0.) dE0 = -dE0;
